...
Raw microphone audio is not uploaded. The app stores only the selected username, a salted slow passphrase hash, and the practice progress/settings required for sync. A short-term account-transfer path is available through 1 August 2026 for existing saved progress.
